...
OTEL_RESOURCE_ATTRIBUTES=deployment.environment=production`,
  ...
  },
  {
    ...
    description: 'OpenTelemetry Collector deployed as one instance per Kubernetes node. Collects host metrics, enriches with k8s metadata. Apps export to localhost.',
    icon: 'Server',
...
spec:
  ...
  },
  {
    ...
    type: 'edge',
    name: 'Sidecar Agent',
    description: 'OpenTelemetry Collector deployed as one instance per pod. Provides per-service isolation and custom config. Works on managed container platforms.',
    icon: 'Box',
    requires: ['kubernetes'],
...
spec:
  ...
  },
  {
    ...
    type: 'edge',
    name: 'Host Agent',
    description: 'OpenTelemetry Collector running as a standalone service on a bare-metal host or VM. Collects host metrics and local application telemetry.',
    icon: 'Server',
    requires: [],
...
export const processingLayers: Layer[] = [
  ...
  },
  {
    ...
    type: 'processing',
    name: 'Gateway Pool',
    description: 'Centralized OpenTelemetry Collector deployment for policy enforcement, multi-backend routing, and credential isolation. Replica count scales with data volume.',
    icon: 'Layers',
    requires: [],
...
spec:
  ...
  },
  {
    ...
    description: 'OpenTelemetry Collector StatefulSet with loadbalancingexporter for trace-aware sampling. All spans of a trace reach the same collector instance.',
    icon: 'GitBranch',
...
exporters:
  ...
  },
  {
    ...
    description: 'File-based WAL on the OpenTelemetry Collector survives crashes. Requires PVC in Kubernetes. Good balance of resilience and simplicity.',
    icon: 'HardDrive',
    requires: [],
...
spec:
  ...
  },
  {
    ...
    type: 'buffering',
    name: 'Kafka Buffer',
    description: 'OpenTelemetry Collector pools bridge an external Kafka cluster for maximum durability. Survives hours of backend outages. Enables replay and multi-consumer.',
    icon: 'Database',
